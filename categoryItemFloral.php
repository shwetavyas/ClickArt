...
function findImagePriceCategoryFloral($num2){
		  $ooClass = new OOClass();
		  $dbc = $ooClass->dbConnect();
         // static $num2 = 1;
          $query = "Select * from paintings where painting_id= '$num2' AND paintingtype = 'floral'";
         // $num2 = $num2 + 1;
	...
	?>		<div class="col-sm-3">
				<div class="product-image-wrapper">
					<div class="single-products">
						...
						<?php  
							//findImageCategory();    
							$result = $ooClass->callingImageCategoryFloral($num2);
							if(!empty($result)){ 
...
<div class="tab-pane fade active in" id="kids" >
							<?php
								...
								$row = mysqli_fetch_array($data);
								for($i=1; $i<=$row['pid']; $i++){ 
									findImagePriceCategoryFloral($i);
								}
							?>
</div>